    ...
    <div class="table-responsive">
        <table class="table">
            ...
            <?php foreach ($users as $user) : ?>
                <tbody>
                    <tr>
                        <th scope="row"><?= htmlspecialchars($user->login(), ENT_QUOTES, 'UTF-8', false); ?></a></th>
                        <td><?= htmlspecialchars($user->email(), ENT_QUOTES, 'UTF-8', false); ?></td>
                        <td><?= $this->replaceBoolByName(htmlentities($user->status()), "user"); ?></td>
                        <td><?= $this->replaceBoolByName(htmlentities($user->admin()), "admin"); ?></td>
                        ...
                        <?php if (htmlentities($user->status()) === "0") : ?>
                        ...
                        <?php elseif (htmlentities($user->status()) === "1") : ?>
